...
class KQKEnv(gym.Env):
    """
    King + Queen vs King endgame environment — v11.

    Like v10 but the opponent can be a neural network agent instead of a
    heuristic. Pass opponent_fn(obs, legal_actions) -> action to use a
    network; leave it None to fall back to the movement_ratio heuristic.
    """
