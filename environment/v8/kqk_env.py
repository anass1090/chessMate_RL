...
class KQKEnv(gym.Env):
    """
    King + Queen vs King endgame environment — v8.

    Same as v7 but with rescaled rewards:
      - Checkmate: 10.0
      - Queen hang: -5.0  (0.5× checkmate)
      - Missed mate: -3.0 (0.3× checkmate)
      - Step penalty: -0.15 per white move
        → optimal ~15-move game costs -2.25, worst case (50 moves) -7.5
