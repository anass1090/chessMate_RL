...
class KQKEnv(gym.Env):
    """
    King + Queen vs King endgame environment — v7.

    Same as v6 but the black king always tries to move toward the center
    instead of moving randomly. This forces the agent to actually learn
    cornering technique rather than relying on the king wandering to the edge.
